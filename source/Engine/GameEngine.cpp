 ...
 * https://github.com/PfAndrey/supermariohd/blob/master/source/GameEngine.cpp
 *
 */
...
{
    auto it = std::find_if(m_objects.begin(), m_objects.end(), [this, &name](const CGameObject *obj) -> bool
